...
public class NewDashboardSummary extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.new_dashboard, container, false);
    ...
    private void rebuildUI(Context context) {
        ...
        for (int n = 0; n < count; n++) {
            ...
            View categoryView = mLayoutInflater.inflate(R.layout.new_dashboard_category, mDashboard,
                    false);
