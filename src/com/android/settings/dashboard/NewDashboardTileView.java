...
public class NewDashboardTileView extends FrameLayout implements View.OnClickListener {
    ...
    public NewDashboardTileView(Context context) {
        this(context, null);
    }

    public NewDashboardTileView(Context context, AttributeSet attrs) {
        super(context, attrs);

        final View view = LayoutInflater.from(context).inflate(R.layout.new_dashboard_tile, this);
